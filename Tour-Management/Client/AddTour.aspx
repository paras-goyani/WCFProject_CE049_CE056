<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTour.aspx.cs" Inherits="Client.AddTour" %>
...
<body>
    <div class="reg" style="height:500px;">
        ...
        <form id="regform" runat="server">
            ...
            <asp:Button ID="Button1" runat="server" Text="Add Place" OnClick="Button1_Click" />
        </form>
    </div>
